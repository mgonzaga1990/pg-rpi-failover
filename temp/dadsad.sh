...
_configure_repmgr(){
    ...
    echo "node_id=$1" >> $repmgr_path/repmgr.conf
    echo "node_name=$2" >> $repmgr_path/repmgr.conf
    ...
    echo "promote_command='${repmgr_path}/repmgr standby promote -f ${repmgr_path}/repmgr.conf --log-to-file'" >> $repmgr_path/repmgr.conf
    echo "follow_command='${repmgr_path}/repmgr standby follow -f ${repmgr_path}/repmgr.conf --log-to-file --upstream-node-id=%n'" >> $repmgr_path/repmgr.conf
